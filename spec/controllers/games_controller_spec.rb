...
describe GamesController do
  ...
  before(:each) do
    ability.can [:create, :read, :update, :destroy], :games
  ...
  describe "GET show" do
    it "assigns the requested game as @game" do
      game = Game.create! valid_attributes
      get :show, default_params.merge(id: game.to_param), valid_session
  ...
  describe "GET edit" do
    it "assigns the requested game as @game" do
      game = Game.create! valid_attributes
      get :edit, default_params.merge(id: game.to_param), valid_session
      assigns(:game).should eq(game)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Game" do
        expect {
          post :create, default_params.merge(game: valid_attributes), valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, default_params.merge(game: {}), valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:attributes=).with({ "ended_at" => "2012-12-27 15:58:08" })
        Game.any_instance.should_receive(:save).and_return(false)
        put :update, default_params.merge(id: game.to_param, game: { "ended_at" => "2012-12-27 15:58:08" }), valid_session
      end

      it "assigns the requested game as @game" do
        game = Game.create! valid_attributes
        put :update, default_params.merge(id: game.to_param, game: valid_attributes), valid_session
        assigns(:game).should eq(game)
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        Game.any_instance.stub(:save).and_return(false)
        Game.any_instance.stub(:errors).and_return(double(:errors, empty?: false))
        put :update, default_params.merge(id: game.to_param, game: { "ended_at" => "invalid value" }), valid_session
        assigns(:game).should eq(game)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested game" do
      game = Game.create! valid_attributes
      expect {
        delete :destroy, default_params.merge(id: game.to_param), valid_session
      }.to change(Game, :count).by(-1)
    end
